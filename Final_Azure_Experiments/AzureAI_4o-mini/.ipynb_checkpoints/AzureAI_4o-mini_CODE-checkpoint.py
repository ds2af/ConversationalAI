...
def evaluate_model(true_labels, predicted_labels, confidence_scores=None):
    ...
    """
    # Clean predictions and ensure they're in the correct form
    ...
    # Ensure that there are valid indices before proceeding with the evaluation
...
def main():
    ...
    EXPERT_DEPLOYMENTS = []# ["gpt-4o-mini", "gpt-4o-2", "gpt-4o-2"]
    EXPERT_THRESHOLDS =[]# [.85, 0.88, 0.9]
